$(document).ready(function () {
    ...
    $("#btnadd").click(function () {
        ...
        $("#outroserv").append('<strong class="cab2" style="background-color:white;border-radius:3px;">Serviço'+cont+':</strong><br>'
            ...
            + '<option value="remoçao de cabelo">Remoçao de Cabelo</option><option value="estetica">Estética</option><option value="massagens">Massagens</option><option value="maquilhagem">Maquilhagem</option>'
